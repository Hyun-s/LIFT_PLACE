...
def DiT_D7_1_2(**kwargs):
    return DiT(depth=7, hidden_size=1152, patch_size=2, num_heads=16, groups=[ [1,2],[1,2],[2,3]], **kwargs)


def DiT_XL_1_7(**kwargs):
    return DiT(depth=28, hidden_size=1152, patch_size=2, num_heads=16, groups=[ [1,7] for _ in range(4) ], **kwargs)
...
# To DiT-D7/2
# def DiT_D7_1_2(**kwargs):
#     # g = [ [1,2] for _ in range(3) ]
#     # g += [[1]]
#     g = [[2,4],[2,3]]
#     return DiT(depth=28, hidden_size=1152, patch_size=2, num_heads=16, groups=g, **kwargs)