...
IMG_PATH=./results_v2/$MODEL_ID/im256

echo "=== Inception Score (IS) ==="
IS_TXT=./results_v2/$MODEL_ID/im256_is.txt
fidelity --gpu $GPU_NUM --isc --input1 $IMG_PATH | tee $IS_TXT
echo "============"

echo "=== Fréchet Inception Distance (FID) ==="
FID_TXT=./results_v2/$MODEL_ID/im256_fid.txt
NPZ_NAME_gen=./results_v2/$MODEL_ID/im256_fid.npz
...
echo "=== CLIP Score ==="
CLIP_TXT=./results_v2/$MODEL_ID/im256_clip.txt
